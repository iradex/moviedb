...
mongoose.connect('mongodb+srv://plutoo:dogfishhouse@cluster0-y8njo.azure.mongodb.net/movieDB?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}); //allowing Mongoose to connect to the database
